                        ...
                        <div class="col-md-4">
                            <ul class="list-group list-group-full">
                                ...
                                <li class="list-group-item"><form method="POST" action="logout">
                                        <input type="hidden" name="_token" value="8m9EpHpB0OvAgP4sAJfxuDM4huxy7dhYVbe6BTFe" />                                        <a href="logout" onclick="event.preventDefault(); this.closest('form').submit()" > Logout <span class="badge badge-info ml-auto pull-right"> <i class="fa fa-sign-out"></i> </span></a>
                                    </form></li>
                            </ul>
                        </div>
                    </div>
